...
party trust for a given capability.
...
``Unintentional'' violation. ``Minimized'' (zero points) indicates that
...
the risk of such violations in the future.
...
%%  LocalWords:  freemium SSPs Heartbleed
